...
This worked brilliantly for robots because every layer was made of the same stuff: small, fast, deterministic control loops. The hierarchy was a gradient of complexity, not a phase transition.

But what happens when the top of your hierarchy isn't just a better planner--it's an LLM that can understand social context, hold a conversation, and reason about another character's intentions? That's not a difference of degree. That's a different kind of cognition sitting on top of the same old reactive stack.

And that changes what the hierarchy can *do*.
